...
<div in:fly={{ y: 15 }}>
	<Card.Root>
			...
			<form action="" method="POST" use:enhance={onSubmit}>
				<div class="space-y-4">
					<div class="space-y-1">
						...
						<Input type="name" id="input-name" name="name" />
					</div>
					<div class="space-y-1">
					...
					<div class="space-y-1">
						...
						<Input type="password" id="input-confirmPassword" name="confirmPassword" />
					</div>
		...
		<Card.Footer class="flex-col items-start gap-4">
			...
			<Button href="/sign-in" variant="secondary" class="w-full">
				Sign In
			</Button>
		</Card.Footer>
	</Card.Root>
